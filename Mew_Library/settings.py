"""
Django settings for Mew_Library project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://mew-library.onrender.com','https://*.127.0.0.1']
...
WSGI_APPLICATION = 'Mew_Library.wsgi.application'
